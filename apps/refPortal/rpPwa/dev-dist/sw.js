...
define(['./workbox-f001acab'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "index.html",
    "revision": "0.gb27pb9lc88"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/^https:\/\/cdn\.plot\.ly\/.*/i, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^https:\/\/.*\.(?:woff|woff2|ttf|eot)$/, new workbox.CacheFirst({
