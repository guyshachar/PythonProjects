...
T = TypeVar("T", bound="Field327327A53F87Fecaeb9F7Cd69C0433AfBodyFieldsItem")


@_attrs_define
class Field327327A53F87Fecaeb9F7Cd69C0433AfBodyFieldsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_327327a53f87_fecaeb_9f7_cd_69c0433_af_body_fields_item = cls(
            field_id=field_id,
            field_name=field_name,
            field_value=field_value,
        )

        field_327327a53f87_fecaeb_9f7_cd_69c0433_af_body_fields_item.additional_properties = d
        return field_327327a53f87_fecaeb_9f7_cd_69c0433_af_body_fields_item
