...
from ...models.field_4d01076149250e9e47f3b8_aa_7_dc_53_baa_body import Field4D01076149250E9E47F3B8Aa7Dc53BaaBody
...
def _get_kwargs(
    *,
    body: Field4D01076149250E9E47F3B8Aa7Dc53BaaBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/fb/subscriber/setCustomFields",
    }
