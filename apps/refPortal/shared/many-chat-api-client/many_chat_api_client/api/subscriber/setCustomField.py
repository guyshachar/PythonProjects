...
from ...models.field_81138a426b0903687848_fdf_8_bdde_6_aa_9_body import Field81138A426B0903687848Fdf8Bdde6Aa9Body
...
def _get_kwargs(
    *,
    body: Field81138A426B0903687848Fdf8Bdde6Aa9Body,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/fb/subscriber/setCustomField",
    }
