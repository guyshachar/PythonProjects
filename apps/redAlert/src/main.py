...
class RedAlert():
    ...
    def get_red_alerts(self, logger):
        ...
        if(len(j["data"]) == 0):
            return None
        logger.info(f'alerts={alerts}, json={j}')
    ...
    def run(self, logger):
        ...
        red_alerts = self.get_red_alerts(logger)
...
#    RedAlert().run(1000, None, None, logging)
